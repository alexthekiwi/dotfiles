---
name: critique
description: Evaluate design from a UX perspective, assessing visual hierarchy, information architecture, emotional resonance, cognitive load, and overall quality through heuristic scoring and persona-based testing. Use when the user asks to review, critique, evaluate, or give feedback on a design or component.
version: 2.1.1
user-invocable: true
...
Read `../impeccable/SKILL.md` and follow its context gathering rules. Establish the interface's purpose from the request and available evidence; missing design documents alone do not block a review.
