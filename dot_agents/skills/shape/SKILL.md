...
Read `../impeccable/SKILL.md` and follow its context gathering rules. Reuse the supplied brief and settled decisions; interview only for the design choices this planning task still needs.
