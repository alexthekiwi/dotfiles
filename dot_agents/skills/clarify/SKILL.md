...
Read `../impeccable/SKILL.md` and follow its context gathering rules. Infer audience technical level and user context from available evidence; ask only about material gaps.
