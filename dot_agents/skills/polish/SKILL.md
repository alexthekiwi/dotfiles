...
Read `../impeccable/SKILL.md` and follow its context gathering rules. Infer the quality bar from the request and current product; ask only about material gaps.
