...
Read `../impeccable/SKILL.md` and follow its context gathering rules. Resolve target platforms, devices, and usage contexts from the request and repository; ask only about material gaps.
