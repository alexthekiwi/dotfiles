...
If a skill would cause a pause, permission request, unfinished work, or a departure from the user's request, cite its exact SKILL.md path and relevant instruction, and distinguish that requirement from your interpretation. Preserve required safety approvals; resolve ordinary workflow conflicts in favour of the user's stated task.
